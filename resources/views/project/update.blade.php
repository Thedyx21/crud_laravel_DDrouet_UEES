...
<head>
    ...
    <meta name="description" content="Gestión de Proyectos - Modificación de Proyectos en la plataforma.">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                <li class="nav-item">
                                    <a class="nav-link active" aria-current="page" href="{{url('project/')}}">Gestión de Proyectos</a>
                                </li>
                                <li class="nav-item">
            ...
            <div class="col-5">
                ...
                <form action="{{ route('project.update', $proyecto->id) }}" method="post">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" name="titulo" id="titulo" class="form-control" value="{{$proyecto->titulo}}" aria-describedby="inputGroup-sizing-default">
                    </div>
